...
public class GetFloatParser {
    ...
    public static void main(String[] args) {
        float fl1 = getFloat("Some string with 15.5 US dollars");
        float fl2 = getFloat("Some string with -15.5 US dollars");
        float fl3 = getFloat("Some string with - 15.5 US dollars");
        float fl4 = getFloat("Some string with 15,5 US dollars");
    ...
    private static float getFloat(String string) {
        float result = 0.0f;
        Pattern pattern = Pattern.compile("[-]?[0-9]+(.[0-9]+)?"); // create pattern for matching with given string
